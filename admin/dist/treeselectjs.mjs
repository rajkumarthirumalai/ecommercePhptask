...
var Zs = (l, e, t) =>
  e in l
    ? Js(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
    : (l[e] = t);
var c = (l, e, t) => (Zs(l, typeof e != "symbol" ? e + "" : e, t), t),
  ft = (l, e, t) => {
    if (!e.has(l)) throw TypeError("Cannot " + t);
  };
var n = (l, e, t) => (
    ft(l, e, "read from private field"), t ? t.call(l) : e.get(l)
  ),
  r = (l, e, t) => {
    if (e.has(l))
  ...
  m = (l, e, t, s) => (
    ft(l, e, "write to private field"), s ? s.call(l, t) : e.set(l, t), t
  );
...
const At = {
  ...
  Qs = (l) =>
    l.reduce(
      (e, { name: t }, s) => ((e += t), s < l.length - 1 && (e += ", "), e),
      ""
    );
var A,
  E,
...
class ei {
  constructor({
    ...
    (this.value = e),
      ...
      (this.placeholder = u),
      (this.clearable = i),
      (this.isAlwaysOpened = o),
      (this.disabled = f),
      (this.isSingleSelect = C),
      (this.id = b),
      (this.iconElements = g),
      (this.isOpened = !1),
      (this.searchText = ""),
      m(this, A, a(this, Ce, Ht).call(this)),
      m(this, E, a(this, ve, $t).call(this)),
      m(this, I, a(this, xe, Ut).call(this)),
      m(this, v, null),
      (this.inputCallback = w),
      (this.searchCallback = k),
      (this.openCallback = O),
      (this.closeCallback = P),
      (this.keydownCallback = R),
      (this.focusCallback = ne),
      (this.blurCallback = mt),
      (this.nameChangeCallback = oe),
      (this.srcElement = a(this, me, Dt).call(
        this,
        n(this, A),
        n(this, E),
        n(this, I)
      )),
      a(this, he, Pt).call(this);
  }
  // Public methods
  focus() {
  ...
  blur() {
    this.isOpened && a(this, T, D).call(this),
      this.clearSearch(),
      n(this, E).blur();
  }
  updateValue(e) {
  ...
  removeItem(e) {
    (this.value = this.value.filter((t) => t.id !== e)),
      a(this, Y, bt).call(this),
      a(this, H, U).call(this),
...
(A = new WeakMap()),
  ...
  (Bt = function () {
    const e = [];
    (n(this, I).innerHTML = ""),
      this.clearable && e.push(a(this, Se, zt).call(this)),
      this.isAlwaysOpened || e.push(a(this, Ae, Kt).call(this, this.isOpened)),
      e.length && n(this, I).append(...e);
  }),
  (pe = new WeakSet()),
  (Vt = function () {
  ...
  (Dt = function (e, t, s) {
    ...
    return (
      ...
      i.addEventListener("mousedown", (o) => a(this, fe, It).call(this, o)),
  ...
  (Gt = function () {
    return this.value.map((e) => {
      ...
      const s = a(this, we, Ft).call(this, e.name),
        i = a(this, ke, qt).call(this);
      return (
        t.addEventListener("mousedown", (o) =>
          a(this, ge, Mt).call(this, o, e.id)
        ),
        t.append(s, i),
        t
      );
  ...
  (Ft = function (e) {
    ...
    return (
      t.classList.add("treeselect-input__tags-name"), (t.textContent = e), t
    );
  }),
  (ke = new WeakSet()),
  (qt = function () {
  ...
  ($t = function () {
    ...
    return (
      ...
      e.addEventListener("keydown", (t) => a(this, Le, Wt).call(this, t)),
      e.addEventListener("input", (t) => a(this, ye, Rt).call(this, t, e)),
      e
    );
  }),
  (Le = new WeakSet()),
  ...
  (zt = function () {
    ...
    return (
      ...
      N(this.iconElements.clear, e),
      e.addEventListener("mousedown", (t) => a(this, _e, Yt).call(this, t)),
      e
    );
  }),
  (_e = new WeakSet()),
  ...
  (Ae = new WeakSet()),
  (Kt = function (e) {
    m(this, v, document.createElement("span")),
...
const Jt = (l, e, t) => {
  ...
  Zt = (l, e, t) => {
    ...
    return !l || e.disabled || e.isPartialChecked
      ? ((e.checked = !1), (e.isPartialChecked = !1), gt(e, s, t), e.checked)
      : es(s, t)
      ? ts(s)
        ? ((e.checked = !1),
          (e.isPartialChecked = !1),
        ...
        : ((e.checked = !1),
          ...
          e.checked)
      : ((e.checked = !0), (e.isPartialChecked = !1), gt(e, s, t), e.checked);
  },
  Qt = (l, e) => {
  ...
  ts = (l) => l.every((e) => !!e.disabled),
  si = (l) => l.every((e) => !!e.checked),
  ii = (l) => l.some((e) => !!e.checked || !!e.isPartialChecked),
  li = (l) => {
    l.forEach((e) => {
  ...
  ss = (l, e, t, s) =>
    l.reduce((i, o) => {
      var C;
      const d = !!((C = o.children) != null && C.length),
        u = s >= e && d,
        f = s > e;
      if (
        (i.push({
  ...
  oi = (l) => {
    const {
        ...
        (o, d) => (
          d.checked &&
            (o.allNodes.push(d),
            d.isGroup ? o.allGroupedNodes.push(d) : o.ungroupedNodes.push(d)),
          o
        ),
        {
          ungroupedNodes: [],
  ...
  ai = (l) => (
    l
      .filter((t) => !!t.disabled)
      .forEach(({ id: t }) => _t({ id: t, checked: !1 }, l)),
    l
  ),
  pt = (l, { id: e, isClosed: t }) => {
    ut({ id: e }, l).forEach((i) => {
      (i.hidden = t ?? !1),
        i.isGroup && !i.isClosed && pt(l, { id: i.id, isClosed: t });
    });
  },
  ri = (l) => {
    l.filter(
  ...
  ci = (l, e) => {
    ...
    l.forEach((s) => {
      t.some(({ id: o }) => o === s.id)
        ? (s.isGroup && ((s.isClosed = !1), pt(l, s)), (s.hidden = !1))
        : (s.hidden = !0);
    });
  },
  di = (l, e) =>
  ...
  is = (l, e) =>
    e.reduce(
      (t, s) => (
        s.childOf === l && (t.push(s), s.isGroup && t.push(...is(s.id, e))), t
      ),
      []
    ),
  ls = (l, e) =>
    e.reduce(
      (t, s) => (
        s.id === l && (t.push(s), s.childOf && t.push(...ls(s.childOf, e))), t
      ),
      []
    ),
  hi = (l) => {
  ...
  ae = (l, e, t, s) => {
    l.forEach((i) => {
      const o = e.querySelector(`[input-id="${i.id}"]`),
        d = _(o);
      (o.checked = i.checked),
        pi(i, d, s),
        mi(i, d),
  ...
  wi = (l, e, t) => {
    ...
    if (s) {
      const d = t.some((f) => f.isGroup && f.level === l.level),
        u = !l.isGroup && d ? `${i}px` : `${o}px`;
      e.style.paddingLeft = l.isGroup ? "0" : u;
    } else
      e.style.paddingLeft = l.isGroup
        ? `${l.level * i}px`
        : `${l.level * i + i}px`;
  ...
  Nt = (l, e) => e.find((t) => t.id.toString() === l),
  Ei = (l) => _(l).querySelector(".treeselect-list__item-icon"),
  vi = (l, e) => {
    e &&
...
class Li {
  constructor({
    ...
    (this.options = e),
      ...
      (this.emptyText = o ?? "No results found..."),
      (this.isSingleSelect = d ?? !1),
      (this.showCount = f ?? !1),
      (this.disabledBranchNode = C ?? !1),
      (this.expandSelected = b ?? !1),
      (this.iconElements = u),
      (this.searchText = ""),
      (this.flattedOptions = ni(this.options, this.openLevel)),
      (this.flattedOptionsBeforeSearch = this.flattedOptions),
      (this.selectedNodes = { nodes: [], groupedNodes: [] }),
      (this.srcElement = a(this, Pe, as).call(this)),
      (this.inputCallback = g),
      (this.arrowClickCallback = w),
      (this.mouseupCallback = k),
      hi(this.flattedOptions);
  }
  // Public methods
  updateValue(e) {
    (this.value = e),
      m(this, y, this.isSingleSelect ? this.value : []),
      ui(
        e,
        this.flattedOptions,
        this.srcElement,
  ...
  updateSearchValue(e) {
    ...
    (this.searchText = e),
      ...
      this.searchText === "" &&
        ((this.flattedOptions = this.flattedOptionsBeforeSearch.map((s) => {
      ...
      this.searchText && ci(this.flattedOptions, e),
      ae(this.flattedOptions, this.srcElement, this.iconElements, n(this, y)),
  ...
  callKeyAction(e) {
    ...
    if (
      t == null ? void 0 : t.classList.contains("treeselect-list__item--hidden")
    )
      return;
    const i = e.key;
    i === "Enter" && t && t.dispatchEvent(new Event("mousedown")),
      (i === "ArrowLeft" || i === "ArrowRight") &&
        a(this, Ne, ns).call(this, t, e),
      (i === "ArrowDown" || i === "ArrowUp") &&
        a(this, Oe, os).call(this, t, i);
  }
  focusFirstListElement() {
    const e = "treeselect-list__item--focused",
      ...
      ).filter((o) => window.getComputedStyle(_(o)).display !== "none");
    if (!s.length) return;
...
(M = new WeakMap()),
  ...
  (ns = function (e, t) {
    ...
    const s = t.key,
      ...
      d = Nt(o, this.flattedOptions),
      u = e.querySelector(".treeselect-list__item-icon");
    s === "ArrowLeft" &&
      !d.isClosed &&
      d.isGroup &&
      (u.dispatchEvent(new Event("mousedown")), t.preventDefault()),
      s === "ArrowRight" &&
        d.isClosed &&
        d.isGroup &&
        (u.dispatchEvent(new Event("mousedown")), t.preventDefault());
  ...
  (os = function (e, t) {
    ...
    if (s.length)
      if (!e) _(s[0]).classList.add("treeselect-list__item--focused");
      else {
        const o = s.findIndex((P) =>
          _(P).classList.contains("treeselect-list__item--focused")
        );
        _(s[o]).classList.remove("treeselect-list__item--focused");
        const u = t === "ArrowDown" ? o + 1 : o - 1,
          f = t === "ArrowDown" ? 0 : s.length - 1,
          C = s[u] ?? s[f],
          b = !s[u],
          g = _(C);
        g.classList.add("treeselect-list__item--focused");
        const w = this.srcElement.getBoundingClientRect(),
  ...
  (Pe = new WeakSet()),
  (as = function () {
    const e = a(this, Be, rs).call(this),
      t = a(this, X, wt).call(this, this.options);
    e.append(...t);
  ...
  (rs = function () {
    ...
    return (
      ...
      e.addEventListener("mouseout", (t) => a(this, Ve, cs).call(this, t)),
      e.addEventListener("mousemove", () => a(this, De, ds).call(this)),
  ...
  (wt = function (e) {
    return e.reduce((t, s) => {
      ...
      if ((o = s.children) != null && o.length) {
        const d = a(this, Ge, ps).call(this, s),
          u = a(this, X, wt).call(this, s.children);
  ...
  (us = function () {
    ...
    t.classList.add("treeselect-list__empty-icon"),
      N(this.iconElements.attention, t);
  ...
  (kt = function (e, t) {
    ...
    const i = a(this, Re, ks).call(this, e),
      o = a(this, Ue, Es).call(this, e, t);
  ...
  (ms = function (e) {
    ...
    return (
      ...
      t.addEventListener("mouseover", () => a(this, Fe, fs).call(this, t), !0),
      t.addEventListener("mouseout", () => a(this, qe, Cs).call(this, t), !0),
      t.addEventListener("mousedown", (s) => a(this, je, bs).call(this, s, e)),
      t
    );
  }),
  (Fe = new WeakSet()),
  ...
  (bs = function (e, t) {
    ...
    if (
      (e.preventDefault(),
      e.stopPropagation(),
      (o = this.flattedOptions.find((d) => d.id === t.value)) == null
        ? void 0
        : o.disabled)
    )
      return;
  ...
  (gs = function () {
    ...
    return (
      ...
      N(this.iconElements.arrowDown, e),
      e.addEventListener("mousedown", (t) => a(this, We, ws).call(this, t)),
      e
    );
  }),
  (We = new WeakSet()),
  ...
  (Ls = function (e, t) {
    ...
    if (s) {
      ...
      if (this.isSingleSelect) {
        ...
        if (s.id === i) return;
        m(this, y, [s.id]),
          Jt([s.id], this.flattedOptions, this.isSingleSelect);
      } else {
        s.checked = e.checked;
  ...
  (ys = function (e) {
    var o, d;
    const t =
        (d = (o = e.target) == null ? void 0 : o.parentNode) == null
          ? void 0
          : d.querySelector("[input-id]"),
      s = (t == null ? void 0 : t.getAttribute("input-id")) ?? null,
      i = Nt(s, this.flattedOptions);
    i &&
      ((i.isClosed = !i.isClosed),
      pt(this.flattedOptions, i),
      ae(this.flattedOptions, this.srcElement, this.iconElements, n(this, y)),
...
class _i {
  constructor({
    ...
    Ot({
      ...
      (this.options = s ?? []),
      (this.openLevel = i ?? 0),
      (this.appendToBody = o ?? !1),
      (this.alwaysOpen = !!(d && !P)),
      (this.showTags = u ?? !0),
      (this.tagsCountText = f ?? "elements selected"),
      (this.clearable = C ?? !0),
      (this.searchable = b ?? !0),
      (this.placeholder = g ?? "Search..."),
      (this.grouped = w ?? !0),
      (this.isGroupedValue = k ?? !1),
      (this.listSlotHtmlComponent = O ?? null),
      (this.disabled = P ?? !1),
      (this.emptyText = R ?? "No results found..."),
      (this.staticList = !!(ne && !this.appendToBody)),
      (this.id = mt ?? ""),
      (this.isSingleSelect = oe ?? !1),
      (this.showCount = qs ?? !1),
      (this.disabledBranchNode = js ?? !1),
      (this.direction = $s ?? "auto"),
      (this.expandSelected = Ws ?? !1),
      (this.saveScrollPosition = Rs ?? !0),
      (this.iconElements = Tt(Us)),
      (this.inputCallback = zs),
      (this.openCallback = Ys),
      (this.closeCallback = Ks),
  ...
  mount() {
    Ot({
      ...
      (this.iconElements = Tt(this.iconElements)),
  ...
  updateValue(e) {
    ...
    if (t) {
      const i = yi(e);
      t.updateValue(i);
      const { groupedNodes: o, nodes: d } = t.selectedNodes,
        u = this.grouped || this.isSingleSelect ? o : d;
      (s = n(this, p)) == null || s.updateValue(u),
        a(this, j, re).call(this, { groupedNodes: o, nodes: d });
    }
  }
  destroy() {
    this.srcElement &&
      (a(this, se, yt).call(this),
      (this.srcElement.innerHTML = ""),
      (this.srcElement = null),
      a(this, W, de).call(this, !0));
  }
  focus() {
  ...
  focusWindowHandler(e) {
    ...
    ((s = this.srcElement) == null ? void 0 : s.contains(e.target)) ||
      ((i = n(this, h)) == null ? void 0 : i.srcElement.contains(e.target)) ||
      ((o = n(this, p)) == null || o.blur(),
      a(this, W, de).call(this, !1),
      a(this, $, ce).call(this, !1));
  }
  blurWindowHandler() {
    var e;
  ...
  updateListPosition() {
    ...
    const e = this.srcElement,
      t = (O = n(this, h)) == null ? void 0 : O.srcElement;
    if (!e || !t) return;
    ...
    if (
      ...
      (t.style.top !== "0px" || t.style.left !== "0px") &&
        ((t.style.top = "0px"), (t.style.left = "0px"));
      const P = i + window.scrollX,
        R = g ? o + window.scrollY - s : o + window.scrollY + d;
      (t.style.transform = `translate(${P}px,${R}px)`),
        (t.style.width = `${u}px`);
    }
    const w = g ? "top" : "bottom";
    t.getAttribute("direction") !== w &&
      (t.setAttribute("direction", w),
      a(this, at, Is).call(this, g, this.appendToBody));
  }
}
(h = new WeakMap()),
  (p = new WeakMap()),
  ...
  (Lt = function (e) {
    ...
    (this.srcElement = t),
      m(this, h, s),
      m(this, p, i),
      m(this, x, this.scrollWindowHandler.bind(this)),
      m(this, S, this.scrollWindowHandler.bind(this)),
      m(this, L, this.focusWindowHandler.bind(this)),
      m(this, V, this.blurWindowHandler.bind(this)),
      this.alwaysOpen && ((o = n(this, p)) == null || o.openClose()),
      this.disabled
  ...
  (j = new WeakSet()),
  (re = function ({ groupedNodes: e, nodes: t }) {
    (this.ungroupedValue = t ? Ct(t) : []),
      (this.groupedValue = e ? Ct(e) : []);
    const s =
      this.isGroupedValue || this.isSingleSelect
        ? this.groupedValue
        : this.ungroupedValue;
  ...
  (Ss = function () {
    ...
    const t = new Li({
      ...
      { groupedNodes: s, nodes: i } = t.selectedNodes,
      o = new ei({
    ...
    return (
      this.appendToBody &&
        m(this, F, new ResizeObserver(() => this.updateListPosition())),
      e.append(o.srcElement),
      { container: e, list: t, input: o }
    );
  }),
  (Ze = new WeakSet()),
  (_s = function (e) {
    ...
    const s =
        (u = (d = n(this, h)) == null ? void 0 : d.selectedNodes) == null
          ? void 0
          : u.nodes,
      i =
        (C = (f = n(this, h)) == null ? void 0 : f.selectedNodes) == null
          ? void 0
          : C.groupedNodes;
    a(this, j, re).call(this, { groupedNodes: i, nodes: s }),
      a(this, le, St).call(this);
  }),
  (Qe = new WeakSet()),
  (As = function (e) {
    var t;
  ...
  (et = new WeakSet()),
  (Ts = function (e) {
    n(this, q) && clearTimeout(n(this, q)),
      m(
        this,
        q,
        setTimeout(() => {
          var t;
          (t = n(this, h)) == null || t.updateSearchValue(e),
            this.updateListPosition();
        }, 350)
      );
  }),
  (tt = new WeakSet()),
  (Ns = function () {
    a(this, $, ce).call(this, !0),
      n(this, L) &&
        n(this, L) &&
        n(this, V) &&
        (document.addEventListener("mousedown", n(this, L), !0),
        document.addEventListener("focus", n(this, L), !0),
        window.addEventListener("blur", n(this, V)));
  }),
  (st = new WeakSet()),
  (Os = function () {
    setTimeout(() => {
  ...
  (Ps = function (e) {
    var o, d, u, f;
    const { groupedNodes: t, nodes: s } = e,
      i = this.grouped || this.isSingleSelect ? t : s;
    (o = n(this, p)) == null || o.updateValue(i),
      a(this, j, re).call(this, { groupedNodes: t, nodes: s }),
      this.isSingleSelect &&
        !this.alwaysOpen &&
        ((d = n(this, p)) == null || d.openClose(),
        (u = n(this, p)) == null || u.clearSearch()),
      (f = n(this, p)) == null || f.focus(),
      a(this, le, St).call(this);
  }),
  (lt = new WeakSet()),
  (Bs = function () {
  ...
  (Vs = function (e) {
    this.selectedName !== e &&
      ((this.selectedName = e), a(this, ct, Gs).call(this));
  }),
  (ot = new WeakSet()),
  (Ds = function () {
    var e;
    (this.isListOpened = !0),
      n(this, x) &&
        n(this, S) &&
        (window.addEventListener("scroll", n(this, x), !0),
        window.addEventListener("resize", n(this, S))),
      !(!n(this, h) || !this.srcElement) &&
        (this.appendToBody
          ? (document.body.appendChild(n(this, h).srcElement),
            (e = n(this, F)) == null || e.observe(this.srcElement))
          : this.srcElement.appendChild(n(this, h).srcElement),
        this.updateListPosition(),
        a(this, ie, xt).call(this, !0),
        a(this, rt, Hs).call(this),
        a(this, dt, Ms).call(this));
  }),
  (se = new WeakSet()),
  (yt = function () {
    var t;
    this.alwaysOpen ||
      ...
      n(this, x) &&
        n(this, S) &&
        (window.removeEventListener("scroll", n(this, x), !0),
        window.removeEventListener("resize", n(this, S))),
      !n(this, h) || !this.srcElement) ||
      !(this.appendToBody
        ? document.body.contains(n(this, h).srcElement)
        : this.srcElement.contains(n(this, h).srcElement)) ||
      (m(this, ee, n(this, h).srcElement.scrollTop),
      this.appendToBody
        ? (document.body.removeChild(n(this, h).srcElement),
          (t = n(this, F)) == null || t.disconnect())
        : this.srcElement.removeChild(n(this, h).srcElement),
      a(this, ie, xt).call(this, !1),
      a(this, ht, Fs).call(this));
  }),
  (at = new WeakSet()),
  (Is = function (e, t) {
    ...
    e
      ? (n(this, h).srcElement.classList.add(s),
        n(this, h).srcElement.classList.remove(i),
        n(this, p).srcElement.classList.add("treeselect-input--top"),
        n(this, p).srcElement.classList.remove("treeselect-input--bottom"))
      : (n(this, h).srcElement.classList.remove(s),
        n(this, h).srcElement.classList.add(i),
  ...
  (ce = function (e) {
    !n(this, p) ||
      !n(this, h) ||
      (e
        ? (n(this, p).srcElement.classList.add("treeselect-input--focused"),
          n(this, h).srcElement.classList.add("treeselect-list--focused"))
        : (n(this, p).srcElement.classList.remove("treeselect-input--focused"),
          n(this, h).srcElement.classList.remove("treeselect-list--focused")));
  }),
  (ie = new WeakSet()),
  (xt = function (e) {
    var t, s, i, o;
    e
      ...
      this.staticList
        ...
        : (o = n(this, h)) == null ||
          o.srcElement.classList.remove("treeselect-list--static");
  }),
  (W = new WeakSet()),
  (de = function (e) {
    !n(this, x) ||
      ...
      ((!this.alwaysOpen || e) &&
        (window.removeEventListener("scroll", n(this, x), !0),
        window.removeEventListener("resize", n(this, S))),
      document.removeEventListener("mousedown", n(this, L), !0),
      document.removeEventListener("focus", n(this, L), !0),
      window.removeEventListener("blur", n(this, V)));
  }),
  (rt = new WeakSet()),
  (Hs = function () {
    var t, s, i;
    ...
    this.saveScrollPosition && e
      ? (s = n(this, h)) == null || s.srcElement.scroll(0, n(this, ee))
      : (i = n(this, h)) == null || i.focusFirstListElement();
  }),
  (le = new WeakSet()),
  (St = function () {
    var e;
  ...
  (Ms = function () {
    ...
    this.alwaysOpen ||
      ((e = this.srcElement) == null ||
        e.dispatchEvent(new CustomEvent("open", { detail: this.value })),
  ...
  (Fs = function () {
    ...
    this.alwaysOpen ||
      ((e = this.srcElement) == null ||
        e.dispatchEvent(new CustomEvent("close", { detail: this.value })),
